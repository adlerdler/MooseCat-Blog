...
<template>
  <div class="p-8">
    ...
    <div v-else class="mt-6">
      <EmptyState 
        :title="t('admin_no_users_found') || 'No users found'"
        :description="t('admin_no_users_description') || 'Try adjusting your search or filters to find what you are looking for'"
        :icon="Users"
      />
    </div>
