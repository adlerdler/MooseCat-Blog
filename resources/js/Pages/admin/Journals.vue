...
<template>
  <div class="p-8">
    ...
    <!-- Content Area -->
    <template v-if="filteredJournals.length > 0">
      ...
      <Pagination
        ...
        :total-items="filteredJournals.length"
    ...
    <div v-else class="mt-6">
      <EmptyState 
        :title="t('admin_no_journals_found') || '没有找到日志'"
        :description="t('admin_no_journals_description') || '尝试调整搜索或筛选条件，或者添加一篇新日志'"
        :icon="BookText"
      />
    </div>
