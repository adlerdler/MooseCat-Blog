...
class ProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $projects = [
            [
                'title' => 'Arkhyx Blog System',
                'slug' => 'arkhyx-blog-system',
                'description' => 'A minimalist, AI-driven blog engine built with Laravel and Vue.',
                'long_description' => 'Arkhyx is a modern blog system that combines minimalist design principles with AI-assisted development workflow. Built using Laravel 11 and Vue.js, it features a clean architecture and powerful content management capabilities.',
                'client' => 'Personal Project',
                'role' => 'Full Stack Developer',
                'year' => 2026,
                'image' => '/images/projects/arkhyx.png',
                'url' => 'https://arkhyx.com',
                'github_url' => 'https://github.com/arkhyx/arkhyx',
                'technologies' => json_encode(['Laravel', 'Vue.js', 'TailwindCSS']),
                'meta_title' => 'Arkhyx Blog System',
