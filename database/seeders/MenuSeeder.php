...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 20, 'type' => 'admin', 'parent_id' => null, 'label_key' => 'admin_user_management', 'icon_name' => 'Users', 'path' => null, 'sort_order' => 8, 'is_active' => true, 'component_name' => null],
            ['id' => 19, 'type' => 'admin', 'parent_id' => null, 'label_key' => 'admin_system', 'icon_name' => 'Settings', 'path' => null, 'sort_order' => 9, 'is_active' => true, 'component_name' => null],
            ...
            ['id' => 217, 'type' => 'admin', 'parent_id' => 21, 'label_key' => 'admin_enable_social_login', 'icon_name' => 'Share2', 'path' => '/admin/social-login', 'sort_order' => 7, 'is_active' => true, 'component_name' => 'AdminSocialLogin'],
